            ...
            <div className="d-flex me-5   w-100">
                <div className="flex-shrink-0">
                {
                    ...
                    <div className={styles.icon_token_letter1}>
                        <h6 className={styles.icon_token_text1}>{tokeninfodata?tokeninfodata.contractInfo.name.charAt(0) :null}</h6>
                    </div>
                }
                ...
                <div className="flex-grow-1 ms-3 ">
                    ...
                    <div className="d-flex align-items-center flex-wrap">
                        <h3 className={styles.name} style={{ fontFamily: 'SF Pro Display Semibold' }}>{tokeninfodata ?(tokeninfodata.contractInfo.name) : null} </h3>
                        <span className={`ms-2   px-2 h-50 fw-light ${styles.symbol}`} style={{ fontSize: '14px', backgroundColor: 'rgba(136, 136, 136,0.2)' }}>{tokeninfodata ? tokeninfodata.contractInfo.symbol : null}</span>
                        {
                        ...
                        <div className=' my-2 col-12 col-md-auto '>
                    ...
                    <div className={`text-start mt-2 d-flex justify-content-between flex-wrap ${styles.badges}`} style={{ fontSize: '12px', fontFamily: 'SF Pro Display Regular' }}>
                        ...
                        {
                            (tokeninfodata && tokeninfodata.contractInfo.logo)?
                              <img className={`rounded-circle `} width={18} src={tokeninfodata.contractInfo.logo} alt={tokeninfodata.contractInfo} />:
                            <div className={styles.icon_token_letter2}>
                                <h6 className={styles.icon_token_text2}>{tokeninfodata?tokeninfodata.contractInfo.name.charAt(0) :null}</h6>
                            </div>
                        }
