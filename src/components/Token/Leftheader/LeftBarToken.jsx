                ...
                <div className="flex-grow-1 ms-3">
                    ...
                    <div className={`d-flex justify-content-between mt-4 ${styles.percent}`}>
                        <div className='text-start'>
                            ...
                            <p className=' mb-2' style={{ fontFamily: 'SF Pro Display Semibold'}}>${tokeninfodata?Math.round(tokeninfodata.contractInfo.tokenPriceUSD):null}</p>
                        ...
                        <div className='text-start'>
                            ...
                            <p className='fs-5 mb-2' style={{ fontFamily: 'SF Pro Display Semibold'}}>${tokeninfodata?tokeninfodata.contractInfo.market_cap:null}</p>
                        ...
                        <div className='text-start'>
                            ...
                            <p className='fs-5 mb-2' style={{ fontFamily: 'SF Pro Display Semibold'}}>{tokeninfodata?Math.round(tokeninfodata.contractInfo.tokenPriceUSD):null} {tokeninfodata?tokeninfodata.contractInfo.symbol:null}</p>
