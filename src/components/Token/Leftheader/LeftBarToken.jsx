                ...
                <div className="flex-grow-1 ms-3">
                    ...
                    <div className='text-start mt-2 d-flex flex-wrap' style={{fontSize:'14px',  fontFamily: 'SF Pro Display Regular'}}>
                        ...
                        <span className='d-flex align-items-center px-2 py-1 me-2 mt-2 d-inline-block' style={{backgroundColor:'rgba(136, 136, 136,0.2)'}}>
                            ...
                            <span style={{fontFamily: 'SF Pro Display Medium'}} className='ps-1'>BSC</span>
                            </span>
                    ...
                    <div className='d-flex justify-content-between mt-4'>
                        <div className='text-start'>
                            ...
                            <p className='fs-4 mb-2' style={{ fontFamily: 'SF Pro Display Semibold'}}>$2698</p>
                        ...
                        <div className='text-start'>
                            <h5 className='text-muted'  style={{fontFamily: 'SF Pro Display Regular'}}>Total Price</h5>
                            <p className='fs-4 mb-2' style={{ fontFamily: 'SF Pro Display Semibold'}}>2698 BTC</p>
